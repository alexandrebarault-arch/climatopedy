...
- [x] **Step 5: Commit the tested rule**
...
- [x] **Step 3: Add and consume the section contract**
...
- [x] **Step 4: Run contract tests and TypeScript**

Run: `node --import tsx --test tests/siteStructure.test.ts`  
Run: `npm run lint`  
Expected: all contract checks pass and TypeScript exits successfully.

- [x] **Step 5: Commit the shared structure contract**
...
- [x] **Step 1: Add failing UI-wiring assertions**
...
- [x] **Step 1: Add failing documentation coverage checks**
...
- [x] **Step 2: Run the documentation contract and verify failure**

Run: `node --import tsx --test tests/siteStructure.test.ts`  
Expected: FAIL because the guide does not yet exist.

- [x] **Step 3: Write the guide from the current implementation**
...
- [x] **Step 5: Commit the architecture guide and final contract assertions**
