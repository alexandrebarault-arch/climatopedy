...
export const SCIENTIFIC_SOURCES_LIST: ScientificSourceItem[] = [
  ...
  // 7. OBSERVATOIRES SATELLITAIRES & MESURES CONTINUES EN TEMPS RÉEL
  {
    ...
    secondaryUrl: 'https://repository.library.noaa.gov/view/noaa/74317',
    secondaryUrlLabel: 'NOAA : bilan mondial du carbone 2025 et moyenne globale annuelle',
    gaiaRole: 'Le moteur initialise 2026 avec la dernière moyenne mondiale annuelle complète disponible : 425,6 ppm en 2025. La valeur est observée; la manière dont les réservoirs carbone évoluent ensuite reste une hypothèse du simulateur.',
    keyDataOrQuote: 'La NOAA rapporte 422,8 ppm de moyenne mondiale annuelle en 2024 et 425,6 ppm en 2025. La valeur initiale du moteur est maintenant alignée sur l’année complète la plus récente; elle n’est pas une moyenne annuelle observée pour 2026.',
