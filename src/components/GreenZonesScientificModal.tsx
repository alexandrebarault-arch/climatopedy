...
export const GreenZonesScientificModal: React.FC<GreenZonesScientificModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-6 bg-black/85 backdrop-blur-md animate-in fade-in duration-200">
      <div 
        className="relative w-full max-w-4xl max-h-[92vh] bg-[#0c1220] border border-emerald-500/40 rounded-2xl shadow-2xl flex flex-col overflow-hidden text-slate-200"
        role="dialog"
        aria-modal="true"
        aria-labelledby="modal-green-zones-title"
      >
        {/* En-tête */}
        <div className="flex items-center justify-between px-6 py-4 border-b border-slate-800 bg-[#101828]">
          <div className="flex items-center gap-3">
            <div className="p-2 rounded-xl bg-emerald-950/80 border border-emerald-500/50 text-emerald-400">
              <TreePine className="w-5 h-5" />
            </div>
            <div>
              <h2 id="modal-green-zones-title" className="text-base sm:text-lg font-bold text-white flex items-center gap-2">
                Pourquoi certaines zones restent-elles vertes en 2100 et 2200 ?
                <span className="text-xs px-2 py-0.5 rounded-full font-mono bg-emerald-900/60 text-emerald-300 border border-emerald-700/60">
        ...
        <div className="flex-1 overflow-y-auto p-5 sm:p-6 space-y-6 text-sm leading-relaxed">
          ...
          {/* Synthèse immédiate */}
          <div className="p-4 rounded-xl bg-emerald-950/30 border border-emerald-800/50 flex items-start gap-3.5">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="bg-[#111728] border border-slate-800 p-4 rounded-xl flex flex-col gap-2.5">
              <div className="flex items-center gap-2 text-cyan-400 font-semibold text-sm">
                <Thermometer className="w-4 h-4" />
                <span>1. Thermodynamique du thermomètre mouillé (Tw)</span>
              </div>
              <p className="text-xs text-slate-300">
                L'inhabitabilité thermique ne dépend pas seulement de la température brute (thermomètre sec), mais de sa combinaison avec l'humidité absolue de l'air (<a href="https://www.pnas.org/doi/10.1073/pnas.0913352107" target="_blank" rel="noreferrer" className="text-cyan-400 underline">Sherwood &amp; Huber 2010 PNAS</a>, <a href="https://www.science.org/doi/10.1126/sciadv.aaw1838" target="_blank" rel="noreferrer" className="text-cyan-400 underline">Raymond et al. 2020 Science Advances</a>).
              </p>
              <ul className="text-xs text-slate-400 list-disc list-inside space-y-1 pl-1">
                <li>
                  <strong className="text-slate-200">Dans les tropiques et golfes humides :</strong> La relation de Clausius-Clapeyron (+7% d'eau par °C) fait exploser l'humidité, rendant la transpiration humaine inopérante (Tw &gt; 31°C).
                </li>
                <li>
                  <strong className="text-slate-200">Dans les hautes latitudes (Canada, Scandinavie) :</strong> Même lors d'étés à 30-34°C, l'air continental ou maritime boréal reste modérément humide. Le Tw estival reste compris entre <strong>18°C et 24°C</strong> (vert/turquoise sur la carte).
                </li>
              </ul>
            </div>
            ...
            <div className="bg-[#111728] border border-slate-800 p-4 rounded-xl flex flex-col gap-2.5">
              ...
              <p className="text-xs text-slate-300">
                La couleur verte reflète aussi un phénomène écologique réel observé par satellite (<a href="https://www.nature.com/articles/nclimate3004" target="_blank" rel="noreferrer" className="text-emerald-400 underline">Zhu et al. 2016 Nature Climate Change</a>, GIEC AR6 GT1 Box TS.3) :
              </p>
              <ul className="text-xs text-slate-400 list-disc list-inside space-y-1 pl-1">
                <li>
                  <strong className="text-slate-200">Verdissement de la toundra :</strong> L'allongement de la saison végétative permet aux arbustes et résineux de coloniser l'extrême nord.
                </li>
                <li>
                  <strong className="text-amber-300">Attention, ce n'est pas un éden :</strong> La frange sud des forêts boréales subit un « brunissement » avec mégafeux incontrôlables, pullulation de scolytes et dégel du pergélisol qui affaisse les sols (thermokarst).
                </li>
              </ul>
            </div>
            ...
            <div className="bg-[#111728] border border-slate-800 p-4 rounded-xl flex flex-col gap-2.5">
              ...
              <ul className="text-xs text-slate-400 list-disc list-inside space-y-1 pl-1">
                <li>
                  Les zones de culture des céréales à paille (blé, orge, avoine) migrent vers les hautes latitudes (<a href="https://www.pnas.org/doi/10.1073/pnas.1701762114" target="_blank" rel="noreferrer" className="text-amber-400 underline">Zhao et al. 2017 PNAS</a>).
                </li>
                <li>
          ...
          <div className="p-4 rounded-xl bg-slate-900 border border-slate-700/80">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-3 text-xs text-slate-300">
              <div className="p-2.5 rounded-lg bg-[#0b101b] border border-slate-800">
                <span className="font-bold text-sky-300 block mb-1">Montée Séculaire des Eaux (+2,6 m)</span>
              ...
              <div className="p-2.5 rounded-lg bg-[#0b101b] border border-slate-800">
                <span className="font-bold text-amber-300 block mb-1">Épuisement Géologique Fossile</span>
              ...
              <div className="p-2.5 rounded-lg bg-[#0b101b] border border-slate-800">
                <span className="font-bold text-emerald-300 block mb-1">Stabilisation Démographique</span>
          ...
          <div className="p-3 rounded-lg bg-[#090d16] border border-slate-800 text-[11px] text-slate-400">
            <span className="font-bold text-slate-300 block mb-1">Sources &amp; Publications Scientifiques de Référence :</span>
        ...
        {/* Pied de page */}
        <div className="px-6 py-3 border-t border-slate-800 bg-[#101828] flex items-center justify-between">
          <span className="text-xs text-slate-400 font-mono">
            Année visualisée : <strong className="text-white">{Math.floor(currentYear)}</strong>
          </span>
          <button
            onClick={onClose}
